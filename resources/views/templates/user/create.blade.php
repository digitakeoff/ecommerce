<form x-data="usercreate" id="modelcreate" enctype='multipart/form-data' method="post" 
class="mx-auto mb-12 sm:w-10/12 w-full p-2" x-on:submit.prevent="handleOnSubmit">
    ...
    <div x-data class="flex flex-col sm:flex-row mt-4">
        <div class="py-1 w-full rounded sm:mr-1 mr-0 sm:w-1/2">
            ...
            <x-text-input id="first_name" class="block mt-1 w-full py-1" type="text" 
                x-model="first_name" :value="old('first_name')" required />
        ...
        <x-text-input id="last_name" class="block mt-1 w-full py-1" type="text" 
            x-model="last_name" :value="old('last_name')" required />
    ...
    <div class="mt-4">
        ...
        <x-text-input id="password" class="block mt-1 w-full py-1" type="password" 
            x-model="password" :value="old('password')" required />
